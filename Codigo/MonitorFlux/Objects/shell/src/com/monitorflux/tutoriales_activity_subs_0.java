...
if (RapidSub.canDelegate("activity_create")) { return com.monitorflux.tutoriales_activity.remoteMe.runUserSub(false, "tutoriales_activity","activity_create", _firsttime);}
...
if (RapidSub.canDelegate("activity_pause")) { return com.monitorflux.tutoriales_activity.remoteMe.runUserSub(false, "tutoriales_activity","activity_pause", _userclosed);}
...
if (RapidSub.canDelegate("activity_resume")) { return com.monitorflux.tutoriales_activity.remoteMe.runUserSub(false, "tutoriales_activity","activity_resume");}
...
if (RapidSub.canDelegate("btnatras_click")) { return com.monitorflux.tutoriales_activity.remoteMe.runUserSub(false, "tutoriales_activity","btnatras_click");}
...
if (RapidSub.canDelegate("setstatusbarcolor")) { return com.monitorflux.tutoriales_activity.remoteMe.runUserSub(false, "tutoriales_activity","setstatusbarcolor", _clr);}
