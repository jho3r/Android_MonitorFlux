...
try {
		Debug.PushSubsStack("Close (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,168);
...
try {
		Debug.PushSubsStack("ContainsKey (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,155);
...
Debug.JustUpdateDeviceLine();
if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean(">",BA.numberCast(double.class, __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(true,"ExecQuerySingleResult2",(Object)(BA.ObjectToString("SELECT count(key) FROM main WHERE key = ?")),(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {_key})))),BA.numberCast(double.class, 0)));
...
try {
		Debug.PushSubsStack("CreateTable (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,174);
...
try {
		Debug.PushSubsStack("DeleteAll (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,161);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.monitorflux.keyvaluestore.class, "_createtable" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Get (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,21);
...
_rs = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery2",(Object)(BA.ObjectToString("SELECT value FROM main WHERE key = ?")),(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {_key}))));Debug.locals.put("rs", _rs);
...
try {
		Debug.PushSubsStack("GetBitmap (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,121);
...
Debug.JustUpdateDeviceLine();
_b = (__ref.runClassMethod (com.monitorflux.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(_key)));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
...
try {
		Debug.PushSubsStack("GetDefault (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,83);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (com.monitorflux.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(_key));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
try {
		Debug.PushSubsStack("GetMapAsync (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,36);
...
public ResumableSub_GetMapAsync(com.monitorflux.keyvaluestore parent,RemoteObject __ref,RemoteObject _keys) {
this.parent = parent;
this.__ref = __ref;
this._keys = _keys;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","97995415",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Initialize (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,7);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_sql1" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(_dir),(Object)(_filename),(Object)(keyvaluestore.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("ListKeys (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,143);
...
_c = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.sql.SQL.ResultSetWrapper"), __ref.getField(false,"_sql1" /*RemoteObject*/ ).runMethod(false,"ExecQuery",(Object)(RemoteObject.createImmutable("SELECT key FROM main"))));Debug.locals.put("c", _c);
...
try {
		Debug.PushSubsStack("Put (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("PutBitmap (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,113);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (com.monitorflux.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(_key),(Object)((_out.runMethod(false,"ToBytesArray"))));
...
try {
		Debug.PushSubsStack("PutMapAsync (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,67);
...
public ResumableSub_PutMapAsync(com.monitorflux.keyvaluestore parent,RemoteObject __ref,RemoteObject _map) {
this.parent = parent;
this.__ref = __ref;
this._map = _map;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","98060936",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Remove (keyvaluestore) ","keyvaluestore",9,__ref.getField(false, "ba"),__ref,138);
