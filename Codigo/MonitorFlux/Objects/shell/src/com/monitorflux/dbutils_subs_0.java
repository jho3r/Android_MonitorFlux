...
if (RapidSub.canDelegate("copydbfromassets")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","copydbfromassets", _ba, _filename);}
...
if (RapidSub.canDelegate("createtable")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","createtable", _ba, _sql, _tablename, _fieldsandtypes, _primarykey);}
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","98978447",RemoteObject.concat(RemoteObject.createImmutable("CreateTable: "),_query),0);
...
if (RapidSub.canDelegate("deleterecord")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","deleterecord", _ba, _sql, _tablename, _wherefieldequals);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99961477",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99961488",RemoteObject.concat(RemoteObject.createImmutable("DeleteRecord: "),_sb.runMethod(true,"ToString")),0);
...
if (RapidSub.canDelegate("droptable")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","droptable", _ba, _sql, _tablename);}
RemoteObject _query = RemoteObject.createImmutable("");
;
Debug.locals.put("SQL", _sql);
Debug.locals.put("TableName", _tablename);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99043971",RemoteObject.concat(RemoteObject.createImmutable("DropTable: "),_query),0);
...
if (RapidSub.canDelegate("escapefield")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","escapefield", _ba, _f);}
;
...
if (RapidSub.canDelegate("executehtml")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executehtml", _ba, _sql, _query, _stringargs, _limit, _clickable);}
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99633800",RemoteObject.concat(RemoteObject.createImmutable("ExecuteHtml: "),_query),0);
...
if (RapidSub.canDelegate("executejson")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executejson", _ba, _sql, _query, _stringargs, _limit, _dbtypes);}
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99568265",RemoteObject.concat(RemoteObject.createImmutable("ExecuteJSON: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99568281",RemoteObject.concat(RemoteObject.createImmutable("Invalid type: "),_dbtypes.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i)))),0);
 break; }
}
;
 }
...
if (RapidSub.canDelegate("executelist")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executelist", _ba, _sql, _query, _stringargs, _limit);}
RemoteObject _table = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
if (RapidSub.canDelegate("executelist2")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executelist2", _ba, _sql, _query, _stringargs, _limit, _list);}
;
Debug.locals.put("SQL", _sql);
Debug.locals.put("Query", _query);
Debug.locals.put("StringArgs", _stringargs);
...
if (RapidSub.canDelegate("executelistview")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executelistview", _ba, _sql, _query, _stringargs, _limit, _listview1, _twolines);}
RemoteObject _table = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
RemoteObject _cols = null;
int _i = 0;
;
...
if (RapidSub.canDelegate("executemap")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executemap", _ba, _sql, _query, _stringargs);}
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99240585",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMap: "),_query),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99240589",RemoteObject.createImmutable("No records found."),0);
...
if (RapidSub.canDelegate("executememorytable")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executememorytable", _ba, _sql, _query, _stringargs, _limit);}
RemoteObject _cur = RemoteObject.declareNull("anywheresoftware.b4a.sql.SQL.ResultSetWrapper");
RemoteObject _table = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99175047",RemoteObject.concat(RemoteObject.createImmutable("ExecuteMemoryTable: "),_query),0);
...
if (RapidSub.canDelegate("executespinner")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","executespinner", _ba, _sql, _query, _stringargs, _limit, _spinner1);}
RemoteObject _table = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
RemoteObject _cols = null;
int _i = 0;
;
...
if (RapidSub.canDelegate("getdbfolder")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","getdbfolder", _ba);}
...
if (RapidSub.canDelegate("getdbversion")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","getdbversion", _ba, _sql);}
...
if (RapidSub.canDelegate("getfieldsinfo")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","getfieldsinfo", _ba, _db, _tablename);}
...
RemoteObject _values = null;
RemoteObject _fieldinfo = RemoteObject.declareNull("com.monitorflux.dbutils._dbfieldinfo");
;
...
Debug.JustUpdateDeviceLine();
_fieldinfo = RemoteObject.createNew ("com.monitorflux.dbutils._dbfieldinfo");Debug.locals.put("FieldInfo", _fieldinfo);
...
if (RapidSub.canDelegate("gettables")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","gettables", _ba, _db);}
;
Debug.locals.put("DB", _db);
...
if (RapidSub.canDelegate("insertmaps")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","insertmaps", _ba, _sql, _tablename, _listofmaps);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99109509",RemoteObject.createImmutable("Same Map found twice in list. Each item in the list should include a different map object."),0);
...
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99109534",RemoteObject.concat(RemoteObject.createImmutable("InsertMaps (first query out of "),_listofmaps.runMethod(true,"getSize"),RemoteObject.createImmutable("): "),_sb.runMethod(true,"ToString")),0);};
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99109541",BA.ObjectToString(dbutils.mostCurrent.__c.runMethod(false,"LastException",_ba)),0);
 };
...
if (RapidSub.canDelegate("setdbversion")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","setdbversion", _ba, _sql, _version);}
;
Debug.locals.put("SQL", _sql);
...
if (RapidSub.canDelegate("tableexists")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","tableexists", _ba, _sql, _tablename);}
...
if (RapidSub.canDelegate("updaterecord")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","updaterecord", _ba, _sql, _tablename, _field, _newvalue, _wherefieldequals);}
;
Debug.locals.put("SQL", _sql);
Debug.locals.put("TableName", _tablename);
...
if (RapidSub.canDelegate("updaterecord2")) { return com.monitorflux.dbutils.remoteMe.runUserSub(false, "dbutils","updaterecord2", _ba, _sql, _tablename, _fields, _wherefieldequals);}
RemoteObject _sb = RemoteObject.declareNull("anywheresoftware.b4a.keywords.StringBuilderWrapper");
RemoteObject _args = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
RemoteObject _col = RemoteObject.createImmutable("");
;
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99895938",RemoteObject.createImmutable("WhereFieldEquals map empty!"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99895942",RemoteObject.createImmutable("Fields empty"),0);
...
Debug.JustUpdateDeviceLine();
dbutils.mostCurrent.__c.runVoidMethod ("LogImpl","99895963",RemoteObject.concat(RemoteObject.createImmutable("UpdateRecord: "),_sb.runMethod(true,"ToString")),0);
