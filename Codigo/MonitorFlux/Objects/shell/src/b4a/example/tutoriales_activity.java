...
public static b4a.example.datos_activity _datos_activity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",tutoriales_activity.mostCurrent._activity,"Agregar_Activity",Debug.moduleToString(b4a.example.agregar_activity.class),"Datos_Activity",Debug.moduleToString(b4a.example.datos_activity.class),"Main",Debug.moduleToString(b4a.example.main.class),"Monitor_Activity",Debug.moduleToString(b4a.example.monitor_activity.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"wv1",tutoriales_activity.mostCurrent._wv1};
}
}