...
if (RapidSub.canDelegate("activity_create")) { b4a.example.agregar_activity.remoteMe.runUserSub(false, "agregar_activity","activity_create", _firsttime); return;}
...
public ResumableSub_Activity_Create(b4a.example.agregar_activity parent,RemoteObject _firsttime) {
this.parent = parent;
...
agregar_activity.mostCurrent._agregar = RemoteObject.createNew ("b4a.example.httpjob");
...
if (RapidSub.canDelegate("jobdone")) { return b4a.example.agregar_activity.remoteMe.runUserSub(false, "agregar_activity","jobdone", _job);}
...
agregar_activity.mostCurrent.__c.runVoidMethod ("LogImpl","15636097",RemoteObject.concat(RemoteObject.createImmutable("JobName = "),_job.getField(true,"_jobname" /*RemoteObject*/ ),RemoteObject.createImmutable(", Success = "),_job.getField(true,"_success" /*RemoteObject*/ )),0);
...
_resagregar(_job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ ));
 break; }
}
;
 }else {
...
Debug.ShouldStop(1);
agregar_activity.mostCurrent.__c.runVoidMethod ("LogImpl","15636104",RemoteObject.concat(RemoteObject.createImmutable("Error: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
...
if (RapidSub.canDelegate("resagregar")) { b4a.example.agregar_activity.remoteMe.runUserSub(false, "agregar_activity","resagregar", _res); return;}
...
public ResumableSub_resAgregar(b4a.example.agregar_activity parent,RemoteObject _res) {
this.parent = parent;
this._res = _res;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.ShouldStop(256);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","15701634",_res,0);
...
if (RapidSub.canDelegate("smsreceiver_messagereceived")) { return b4a.example.agregar_activity.remoteMe.runUserSub(false, "agregar_activity","smsreceiver_messagereceived", _from, _body);}
...
Debug.ShouldStop(8192);
agregar_activity.mostCurrent._agregar.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,agregar_activity.processBA,(Object)(BA.ObjectToString("agregar")),(Object)(agregar_activity.getObject()));
...
Debug.ShouldStop(131072);
agregar_activity.mostCurrent._agregar.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(agregar_activity.mostCurrent._urlagregar),(Object)(_datos));
 BA.debugLineNum = 115;BA.debugLine="Agregar.GetRequest.SetContentType(\"application/j";
Debug.ShouldStop(262144);
agregar_activity.mostCurrent._agregar.runClassMethod (b4a.example.httpjob.class, "_getrequest" /*RemoteObject*/ ).runVoidMethod ("SetContentType",(Object)(RemoteObject.createImmutable("application/json")));
