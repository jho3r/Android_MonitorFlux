...
public static b4a.example.datos_activity _datos_activity = null;
  public Object[] GetGlobals() {
		return new Object[] {"Agregar_Activity",Debug.moduleToString(b4a.example.agregar_activity.class),"Datos_Activity",Debug.moduleToString(b4a.example.datos_activity.class),"Main",Debug.moduleToString(b4a.example.main.class),"Monitor_Activity",Debug.moduleToString(b4a.example.monitor_activity.class),"Service",starter.mostCurrent._service,"Tutoriales_Activity",Debug.moduleToString(b4a.example.tutoriales_activity.class)};
}
}