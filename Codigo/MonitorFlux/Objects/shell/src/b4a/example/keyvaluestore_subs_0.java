...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.keyvaluestore.class, "_createtable" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_b = (__ref.runClassMethod (b4a.example.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(_key)));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
...
Debug.JustUpdateDeviceLine();
_res = __ref.runClassMethod (b4a.example.keyvaluestore.class, "_get" /*RemoteObject*/ ,(Object)(_key));Debug.locals.put("res", _res);Debug.locals.put("res", _res);
...
public ResumableSub_GetMapAsync(b4a.example.keyvaluestore parent,RemoteObject __ref,RemoteObject _keys) {
this.parent = parent;
this.__ref = __ref;
this._keys = _keys;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","93276823",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(_key),(Object)((_out.runMethod(false,"ToBytesArray"))));
...
public ResumableSub_PutMapAsync(b4a.example.keyvaluestore parent,RemoteObject __ref,RemoteObject _map) {
this.parent = parent;
this.__ref = __ref;
this._map = _map;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","93342344",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
