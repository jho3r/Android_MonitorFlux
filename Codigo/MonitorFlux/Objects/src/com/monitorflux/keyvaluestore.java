...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.monitorflux.keyvaluestore");
            if (htSubs == null) {
...
public ResumableSub_GetMapAsync(com.monitorflux.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
...
public ResumableSub_PutMapAsync(com.monitorflux.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
com.monitorflux.keyvaluestore parent;
