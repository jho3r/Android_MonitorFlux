...
views.get("btnmonitoreo").vw.setTop((int)((55d / 100 * height)));
views.get("btnmonitoreo").vw.setHeight((int)((9d / 100 * height)));
...
views.get("btnagregar").vw.setTop((int)((65d / 100 * height)));
views.get("btnagregar").vw.setHeight((int)((9d / 100 * height)));
...
views.get("btntutorial").vw.setTop((int)((75d / 100 * height)));
views.get("btntutorial").vw.setHeight((int)((9d / 100 * height)));
...
views.get("btnout").vw.setTop((int)((85d / 100 * height)));
views.get("btnout").vw.setWidth((int)((80d / 100 * width)));
views.get("btnout").vw.setHeight((int)((9d / 100 * height)));
views.get("btnout").vw.setLeft((int)((50d / 100 * width) - (views.get("btnout").vw.getWidth() / 2)));
