...
//BA.debugLineNum = 63;BA.debugLine="panel.Top = 8%y"[Datos/General script]
views.get("panel").vw.setTop((int)((8d / 100 * height)));
//BA.debugLineNum = 64;BA.debugLine="panel.Width = 48%x"[Datos/General script]
views.get("panel").vw.setWidth((int)((48d / 100 * width)));
//BA.debugLineNum = 65;BA.debugLine="panel.Left = 50%x"[Datos/General script]
views.get("panel").vw.setLeft((int)((50d / 100 * width)));
//BA.debugLineNum = 66;BA.debugLine="panel.Height = 16%y"[Datos/General script]
views.get("panel").vw.setHeight((int)((16d / 100 * height)));
//BA.debugLineNum = 68;BA.debugLine="lbHistorial.Top = 0%y"[Datos/General script]
views.get("lbhistorial").vw.setTop((int)((0d / 100 * height)));
//BA.debugLineNum = 69;BA.debugLine="lbHistorial.Left= 0%x"[Datos/General script]
views.get("lbhistorial").vw.setLeft((int)((0d / 100 * width)));
//BA.debugLineNum = 70;BA.debugLine="lbHistorial.Height = 8%y"[Datos/General script]
views.get("lbhistorial").vw.setHeight((int)((8d / 100 * height)));
//BA.debugLineNum = 71;BA.debugLine="lbHistorial.Width = 48%x"[Datos/General script]
views.get("lbhistorial").vw.setWidth((int)((48d / 100 * width)));
//BA.debugLineNum = 73;BA.debugLine="lbEliminar.Top = 8%y"[Datos/General script]
views.get("lbeliminar").vw.setTop((int)((8d / 100 * height)));
//BA.debugLineNum = 74;BA.debugLine="lbEliminar.Left = 0%x"[Datos/General script]
views.get("lbeliminar").vw.setLeft((int)((0d / 100 * width)));
//BA.debugLineNum = 75;BA.debugLine="lbEliminar.Height = 8%y"[Datos/General script]
views.get("lbeliminar").vw.setHeight((int)((8d / 100 * height)));
//BA.debugLineNum = 76;BA.debugLine="lbEliminar.Width = 48%x"[Datos/General script]
views.get("lbeliminar").vw.setWidth((int)((48d / 100 * width)));
