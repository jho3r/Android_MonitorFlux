...
anywheresoftware.b4a.keywords.Common.LogImpl("51507347",BA.ObjectToString(_mapconsulta.GetKeyAt(_i))+","+BA.ObjectToString(_mapconsulta.GetValueAt(_i))+"de dato actualizado",0);
 }
};
...
anywheresoftware.b4a.keywords.Common.LogImpl("51441806",BA.ObjectToString(_mapconsulta.GetKeyAt(_i))+","+BA.ObjectToString(_mapconsulta.GetValueAt(_i)),0);
 }
};
...
anywheresoftware.b4a.keywords.Common.LogImpl("51441810","Mantener igual a 1 intentando incio de sesion",0);
 //BA.debugLineNum = 77;BA.debugLine="Return True";
if (true) return anywheresoftware.b4a.keywords.Common.True;
 }else {
 //BA.debugLineNum = 79;BA.debugLine="Log(\"No se tiene mantener = 1, pasando a ventana";
anywheresoftware.b4a.keywords.Common.LogImpl("51441813","No se tiene mantener = 1, pasando a ventana de iniciar sesion",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("51179663",BA.ObjectToString(_mapconsulta.GetKeyAt(_i))+","+BA.ObjectToString(_mapconsulta.GetValueAt(_i)),0);
 }
};
