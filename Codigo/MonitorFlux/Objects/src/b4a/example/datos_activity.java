...
anywheresoftware.b4a.keywords.Common.LogImpl("73604506",BA.NumberToString(_fechaactual),0);
RDebugUtils.currentLine=3604507;
 //BA.debugLineNum = 3604507;BA.debugLine="Log(fecha)";
anywheresoftware.b4a.keywords.Common.LogImpl("73604507",BA.NumberToString(_fecha),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("73407873","JobName = "+_job._jobname /*String*/ +", Success = "+BA.ObjectToString(_job._success /*boolean*/ ),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("73407882","Error: "+_job._errormessage /*String*/ ,0);
